...
// SetDuplicateConnectionBehavior provides a mock function with given fields: behavior
func (_m *MockServer) SetDuplicateConnectionBehavior(behavior ws.DuplicateConnectionBehavior) {
	_m.Called(behavior)
}

// MockServer_SetDuplicateConnectionBehavior_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetDuplicateConnectionBehavior'
type MockServer_SetDuplicateConnectionBehavior_Call struct {
	*mock.Call
}

// SetDuplicateConnectionBehavior is a helper method to define mock.On call
//   - behavior ws.DuplicateConnectionBehavior
func (_e *MockServer_Expecter) SetDuplicateConnectionBehavior(behavior interface{}) *MockServer_SetDuplicateConnectionBehavior_Call {
	return &MockServer_SetDuplicateConnectionBehavior_Call{Call: _e.mock.On("SetDuplicateConnectionBehavior", behavior)}
}

func (_c *MockServer_SetDuplicateConnectionBehavior_Call) Run(run func(behavior ws.DuplicateConnectionBehavior)) *MockServer_SetDuplicateConnectionBehavior_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ws.DuplicateConnectionBehavior))
	})
	return _c
}

func (_c *MockServer_SetDuplicateConnectionBehavior_Call) Return() *MockServer_SetDuplicateConnectionBehavior_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockServer_SetDuplicateConnectionBehavior_Call) RunAndReturn(run func(ws.DuplicateConnectionBehavior)) *MockServer_SetDuplicateConnectionBehavior_Call {
	_c.Run(run)
	return _c
}
